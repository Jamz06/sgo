...
(function(h){var b={options:{curPage:0,totalPages:0,totalRecords:0,msg:"",rPPOptions:[10,20,30,40,50,100],rPP:20},_regional:{strDisplay:"Показано с {0} по {1} из {2} элементов.",strFirstPage:"Первая страница",strLastPage:"Последняя страница",strNextPage:"Следующая страница",strPage:"Страница {0} of {1}",strPrevPage:"Предыдущая страница",strRefresh:"Обновить",strRpp:"Записей на страницу:{0}"}};h.extend(b.options,b._regional);b._create=function(){var b=this,k=this.options;this.element.addClass("pq-pager");this.first=h("<button type='button' title='"+
